...
public_version: true
generated: "2026-06-12T14:38:40.618429+00:00"
---
...
| Field | Value |
|---|---|
| Authors | A. Rack, F. García-Moreno, T. Baumbach, J. Banhart |
| Year | 2009 |
...
| garc | recurring term detected from title/metadata/PDF text |
| banhart | recurring term detected from title/metadata/PDF text |
...
| wall | recurring term detected from title/metadata/PDF text |
| synchrotron | recurring term detected from title/metadata/PDF text |

## Chinese Reading Note

这篇论文由 A. Rack et al. 发表，主题集中在 X-ray tomography。脚本已按 nature-reader 的 source-map-first 思路读取本地 PDF，并用章节位置、术语表和元数据生成公开版阅读笔记；由于目标仓库是公开 GitHub Pages，本文件不包含论文全文原文、全文中文翻译或完整图表复刻。
...
- 公开版仅记录方法线索，不复写论文正文。
- 高频术语：time, rupture, metal, garc, banhart, fast, cell, liquid。
...
- Zotero item key: `A3CSNBVI`
- Attachment key: `ITCBJGPD`
- DOI: 10.1107/S0909049509001939
- URL: Not recorded
