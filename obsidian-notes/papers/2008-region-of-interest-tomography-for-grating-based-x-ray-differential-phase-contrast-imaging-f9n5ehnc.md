...
public_version: true
generated: "2026-06-12T14:39:32.717811+00:00"
---
...
| Canonical term | Note |
|---|---|
| phase-contrast | recurring term detected from title/metadata/PDF text |
...
| center | recurring term detected from title/metadata/PDF text |
| differential | recurring term detected from title/metadata/PDF text |
| line | recurring term detected from title/metadata/PDF text |
...
这篇论文由 F. Pfeiffer et al. 发表，主题集中在 X-ray tomography。脚本已按 nature-reader 的 source-map-first 思路读取本地 PDF，并用章节位置、术语表和元数据生成公开版阅读笔记；由于目标仓库是公开 GitHub Pages，本文件不包含论文全文原文、全文中文翻译或完整图表复刻。
...
- 公开版仅记录方法线索，不复写论文正文。
- 高频术语：phase-contrast, used, phys, where, x-ray, center, differential, line。
...
- Zotero item key: `F9N5EHNC`
- Attachment key: `NNF6A9Q4`
- DOI: 10.1103/PhysRevLett.101.168101
- URL: Not recorded
