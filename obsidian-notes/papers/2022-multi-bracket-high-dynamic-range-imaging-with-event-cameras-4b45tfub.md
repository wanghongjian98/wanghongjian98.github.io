...
public_version: true
generated: "2026-06-12T14:05:52.950386+00:00"
---
...
这篇论文由 Nico Messikommer et al. 发表，主题集中在 event-based imaging, motion restoration。脚本已按 nature-reader 的 source-map-first 思路读取本地 PDF，并用章节位置、术语表和元数据生成公开版阅读笔记；由于目标仓库是公开 GitHub Pages，本文件不包含论文全文原文、全文中文翻译或完整图表复刻。
...
- 公开版仅记录方法线索，不复写论文正文。
- 高频术语：events, images, camera, dynamic, motion, feature, range, they。
...
- Zotero item key: `4B45TFUB`
- Attachment key: `5DGLQFNZ`
- DOI: 10.1109/CVPRW56347.2022.00070
- URL: Not recorded
