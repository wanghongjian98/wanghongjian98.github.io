...
public_version: true
generated: "2026-06-12T15:00:43.344434+00:00"
---
...
| warping | recurring term detected from title/metadata/PDF text |
...
这篇论文由 Jiaben Chen et al. 发表，主题集中在 event-based imaging。脚本已按 nature-reader 的 source-map-first 思路读取本地 PDF，并用章节位置、术语表和元数据生成公开版阅读笔记；由于目标仓库是公开 GitHub Pages，本文件不包含论文全文原文、全文中文翻译或完整图表复刻。
...
- 公开版仅记录方法线索，不复写论文正文。
- 高频术语：event, frame, flow, module, optical, synthesis, interpolation, warping。
...
- Zotero item key: `XLCQXL6J`
- Attachment key: `7SKFQD68`
- DOI: 10.1109/IROS55552.2023.10341804
- URL: Not recorded
