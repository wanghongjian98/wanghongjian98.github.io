...
public_version: true
generated: "2026-06-12T14:39:45.126327+00:00"
---
...
| nih-pa | recurring term detected from title/metadata/PDF text |
| optimization | recurring term detected from title/metadata/PDF text |
| constrained | recurring term detected from title/metadata/PDF text |

## Chinese Reading Note

这篇论文由 Emil Y Sidky et al. 发表，主题集中在 X-ray tomography。脚本已按 nature-reader 的 source-map-first 思路读取本地 PDF，并用章节位置、术语表和元数据生成公开版阅读笔记；由于目标仓库是公开 GitHub Pages，本文件不包含论文全文原文、全文中文翻译或完整图表复刻。
...
- 公开版仅记录方法线索，不复写论文正文。
- 高频术语：image, algorithm, author, manuscript, reconstruction, projection, problem, nih-pa。
...
- Zotero item key: `48H2CB3C`
- Attachment key: `LHNSVFCB`
- DOI: 10.1088/0031-9155/53/17/021
- URL: Not recorded
