...
public_version: true
generated: "2026-06-12T13:25:13.342195+00:00"
---
...
| Canonical term | Note |
|---|---|
| calibration | recurring term detected from title/metadata/PDF text |
...
| circles | recurring term detected from title/metadata/PDF text |
| camera | recurring term detected from title/metadata/PDF text |
| sensor | recurring term detected from title/metadata/PDF text |
| centers | recurring term detected from title/metadata/PDF text |
| clustering | recurring term detected from title/metadata/PDF text |
| algorithm | recurring term detected from title/metadata/PDF text |

## Chinese Reading Note

这篇论文由 Mohammed Salah et al. 发表，主题集中在 event-based imaging。脚本已按 nature-reader 的 source-map-first 思路读取本地 PDF，并用章节位置、术语表和元数据生成公开版阅读笔记；由于目标仓库是公开 GitHub Pages，本文件不包含论文全文原文、全文中文翻译或完整图表复刻。
...
- 公开版仅记录方法线索，不复写论文正文。
- 高频术语：calibration, event, where, pattern, circles, camera, sensor, centers。
...
- Zotero item key: `B89JNDYT`
- Attachment key: `6RFKFDDL`
- DOI: 10.1109/TIP.2024.3410673
- URL: Not recorded
