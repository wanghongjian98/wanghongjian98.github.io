...
public_version: true
generated: "2026-06-12T14:36:57.193755+00:00"
---
...
| URL | Not recorded |
| Zotero key | `KTM7E8HB` |
| PDF pages read | 38/38 |
| PDF hash | `06b429fac85b02a0` |
...
| weighting | recurring term detected from title/metadata/PDF text |
...
这篇论文由 Junguo Bian et al. 发表，主题集中在 X-ray tomography。脚本已按 nature-reader 的 source-map-first 思路读取本地 PDF，并用章节位置、术语表和元数据生成公开版阅读笔记；由于目标仓库是公开 GitHub Pages，本文件不包含论文全文原文、全文中文翻译或完整图表复刻。
...
- 公开版仅记录方法线索，不复写论文正文。
- 高频术语：reconstruction, model, image, imaging, algorithms, cbct, weighting, author。
...
- Zotero item key: `KTM7E8HB`
- Attachment key: `85KJD7SI`
- DOI: 10.1088/0031-9155/58/2/205
- URL: Not recorded
