...
public_version: true
generated: "2026-06-12T14:19:14.063814+00:00"
---
...
| limited | recurring term detected from title/metadata/PDF text |
| d-ct | recurring term detected from title/metadata/PDF text |
| sampling | recurring term detected from title/metadata/PDF text |
| time | recurring term detected from title/metadata/PDF text |
| warp | recurring term detected from title/metadata/PDF text |

## Chinese Reading Note

这篇论文由 Albert W. Reed et al. 发表，主题集中在 X-ray tomography, motion restoration。脚本已按 nature-reader 的 source-map-first 思路读取本地 PDF，并用章节位置、术语表和元数据生成公开版阅读笔记；由于目标仓库是公开 GitHub Pages，本文件不包含论文全文原文、全文中文翻译或完整图表复刻。
...
- 公开版仅记录方法线索，不复写论文正文。
- 高频术语：motion, scene, reconstruction, field, view, limited, d-ct, sampling。
...
- Zotero item key: `RCZDPFD3`
- Attachment key: `EQNEJLIP`
- DOI: 10.1109/ICCV48922.2021.00226
- URL: Not recorded
